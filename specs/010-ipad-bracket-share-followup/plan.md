...
1. Add failing browser and unit checks for concise formats, reset behavior,
   stacked names, final/bronze geometry, header edit controls, and copy.
2. Repair the live bracket tree and tournament setup.
